...
public class NewStoreAction : MonoBehaviour
{

	[DllImport("__Internal")]
	private static extern void openWindow(string url);

	public static NewStoreAction INSTANCE;

	public GameObject dialogPanel, pieceInformationPanel;
	public Canvas shoppingCartPanel;
	public TextMeshProUGUI paymentStatus, purchaseMessage;
	public Image purchaseStatus;
	public Sprite completePurchase, cancelPurchase, waitingPurchase;
	...
	// StoreItemContent itemToPurchase
	public void OpenPurchaseItemScreen(string name, string description, string price)
	{
		...
		createPaymentAPICall.accessToken = NewStoreStartupBehaviour.INSTANCE.accessToken;
		createPaymentAPICall.transactionDescription = string.Format("In-game PayPal purchase for {0}: {1}", new object[] { Application.productName, "Imagen" });
		...
		createPaymentAPICall.itemName = name;
		createPaymentAPICall.itemDescription = description;
		createPaymentAPICall.itemPrice = price;
			...
			case PurchaseStatus.WAITING:
				{
					...
					shoppingCartPanel.enabled = false;
					purchaseStatus.sprite = waitingPurchase;
					paymentStatus.text = "Esperando...";
					purchaseMessage.text = "Se ha abierto una pestaña de Paypal en su navegador para completar la compra.";
					// PurchaseItemFields.SetActive(true);
					// PurchaseActionButton.gameObject.SetActive(true);
					// PurchaseScreenSpinner.SetActive(true);
			...
			case PurchaseStatus.COMPLETE:
				{
					...
					pieceInformationPanel.SetActive(false);
					shoppingCartPanel.enabled = false;
					purchaseStatus.sprite = completePurchase;
					paymentStatus.text = "Compra exitosa";
					purchaseMessage.text = "¡Gracias por su compra!";
					// PurchaseItemFields.SetActive(true);
					// PurchaseActionButton.gameObject.SetActive(false);
					// PurchaseScreenSpinner.SetActive(false);
					// PurchaseScreenSpinner.SetActive(false);
			...
			case PurchaseStatus.INCOMPLETE:
				{
					...
					pieceInformationPanel.SetActive(false);
					shoppingCartPanel.enabled = false;
					purchaseStatus.sprite = cancelPurchase;
					paymentStatus.text = "Inténtelo de nuevo";
					purchaseMessage.text = "¡No se pudo completar la compra!";
				}
				break;
